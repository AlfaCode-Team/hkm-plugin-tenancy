...
> `plugins/Database`'s `ConnectionManager`. Pairs with [Kernel security](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/09_SECURITY.md),
> [Database plugin](https://github.com/AlfaCode-Team/hkm-plugin-database/blob/main/docs/DATABASE.md), [User plugin](https://github.com/AlfaCode-Team/hkm-plugin-user/blob/main/docs/USER.md).
...
`TENANCY_TEMPLATE_PATH`). See [Migrations](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/18_MIGRATIONS.md).
