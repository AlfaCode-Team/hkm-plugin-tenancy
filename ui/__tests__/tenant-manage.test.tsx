...
import Page from "../admin/Pages/Tenant/Manage";
import fixture from "../__fixtures__/tenant-manage.json";

/**
 * Component test for `Tenant/Manage`.
 *
 * Props come from __fixtures__/tenant-manage.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/tenant-manage.json');
 *
...
describe.skipIf(pending)("Tenant/Manage", () => {
