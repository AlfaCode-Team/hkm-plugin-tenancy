...
import Page from "../admin/Pages/Tenant/Create";
import fixture from "../__fixtures__/tenant-create.json";

/**
 * Component test for `Tenant/Create`.
 *
 * Props come from __fixtures__/tenant-create.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/tenant-create.json');
 *
...
describe.skipIf(pending)("Tenant/Create", () => {
