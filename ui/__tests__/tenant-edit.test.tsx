...
import Page from "../admin/Pages/Tenant/Edit";
import fixture from "../__fixtures__/tenant-edit.json";

/**
 * Component test for `Tenant/Edit`.
 *
 * Props come from __fixtures__/tenant-edit.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/tenant-edit.json');
 *
...
describe.skipIf(pending)("Tenant/Edit", () => {
