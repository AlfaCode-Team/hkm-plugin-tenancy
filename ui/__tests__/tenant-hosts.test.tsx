...
import Page from "../site/Pages/Tenant/Hosts";
import fixture from "../__fixtures__/tenant-hosts.json";

/**
 * Component test for `Tenant/Hosts`.
 *
 * Props come from __fixtures__/tenant-hosts.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/tenant-hosts.json');
 *
...
describe.skipIf(pending)("Tenant/Hosts", () => {
